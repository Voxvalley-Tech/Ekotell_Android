...
/**
 * This class will view the chat contacts with save to native device options
 * if opened contact is sender side it won't show any saving options
 * if opened conatct is receiver side it will show new/existing contact save options
 */
public class ContactViewActivity extends AppCompatActivity {
    ...
    /**
     * This method will create new contact in device
     */
...
//Filling data with phone numbers
    ...
    /**
     * This method will save the contact in already existed contact
     */
...
//Filling data with phone numbers
    ...
    /**
     * This class will display the list of numbers
     */
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof ContactViewHolder) {
                ...
                try {
                    ...
                    LOG.info("onBindViewHolder: conatct type " + labelsList.get(position).toString());
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
    ...
    /**
     * This method will retun the contact type
     * @param conatctType
     * @return
     */
