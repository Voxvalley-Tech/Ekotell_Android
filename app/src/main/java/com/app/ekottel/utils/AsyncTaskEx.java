...
public abstract class AsyncTaskEx<Params, Progress, Result> {
    ...
    private final Set<IOnFinishedListener> mOnFinishedListeners = new HashSet<IOnFinishedListener>();
    ...
    private Result postResult(final Result result) {
        @SuppressWarnings("unchecked") final Message message = sHandler.obtainMessage(MESSAGE_POST_RESULT, new AsyncTaskExResult(this, result));
     ...
     * If {@link #getStatus()} returns either {listviewvariants.utils.async_task_thread_pool.AsyncTaskEx.Status#RUNNING} or {listviewvariants.utils.async_task_thread_pool.AsyncTaskEx.Status#FINISHED}.
     ...
     * @return This instance of CustomAsyncTask.
     * @throws IllegalStateException
     * If {@link #getStatus()} returns either {lb.listviewvariants.utils.async_task_thread_pool.AsyncTaskEx.Status#RUNNING} or {listviewvariants.utils.async_task_thread_pool.AsyncTaskEx.Status#FINISHED}.
     * @see #execute(Object[])
     */
