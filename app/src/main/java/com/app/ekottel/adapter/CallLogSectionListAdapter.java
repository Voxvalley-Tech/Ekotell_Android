 ...
 * @version 2017
 */
public class CallLogSectionListAdapter extends BaseAdapter implements ListAdapter {
    ...
    private String TAG1="CallLogs";


    public CallLogSectionListAdapter(Context context, final LayoutInflater inflater,
    ...
    /**
     * This is used for display updated section
     *
     * @param section this is used for display section name
     * @param sectionView display section view
     */
    private  void setSectionText(final String section, final View sectionView) {
        ...
        LOG.info(TAG1,"Country Code" + section);
